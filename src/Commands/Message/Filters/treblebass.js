   ...
   desc: "Toggles treblebass filter!",
    ...
    run: async ({ client, message, emojis, player, args }) => {
        ...
        const embed = new EmbedBuilder()
            .setDescription(`<:filters:1176868443207774309> **Treble Bass Filter**`)
            ...
            message.channel.send({ embeds: [embed], components: [row] }).then(async msg => {
                ...
                const embed = new EmbedBuilder()
                    .setDescription(`<:check:1176864155303673996> | **Treble Bass Filter Turned On**`)
                    .setColor(client.settings.COLOR)
                ...
                player.send(data);
                const embed = new EmbedBuilder()
                    .setDescription(`<:check:1176864155303673996> | **Treble Bass Filter Turned Off**`)
                    .setColor(client.settings.COLOR)
                message.channel.send({ embeds: [embed] });
                msg.delete();
            }
